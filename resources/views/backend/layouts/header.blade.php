<link href="{{ url('backend/images/favicon.png') }}" rel="shortcut icon" type="image/x-icon">
<link href="{{ url('backend/images/favicon.png') }}" rel="apple-touch-icon" sizes="144x144">
<link href="{{ url('backend/images/favicon.png') }}" rel="apple-touch-icon" sizes="114x114">
<link href="{{ url('backend/images/favicon.png') }}" rel="apple-touch-icon" sizes="72x72">
<link href="{{ url('backend/images/favicon.png') }}" rel="apple-touch-icon">
